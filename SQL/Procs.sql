...
go
create proc USP_GetIDCustomerFromBookRoom
@idReceiveRoom int
as
begin
	select B.IDCustomer
...
go
create proc USP_UpdateCustomer_
...
go
create proc USP_GetIDRoomFromReceiveRoom
@idReceiveRoom int
as
begin
	select IDRoom
...
go
create proc USP_GetRoomTypeByIdBookRoom
@idBookRoom int
as
begin
	select B.*
...
create proc USP_UpdateBookRoom
...
go
create proc USP_DeleteBookRoom
@id int
as
begin
...
go
create proc USP_ShowReceiveRoom
@idReceiveRoom int
as
begin
...
go
create proc USP_ShowCustomerFromReceiveRoom
@idReceiveRoom int
as
begin
...
go
create proc USP_DeleteReceiveRoomDetails
@idReceiveRoom int,@idCustomer int
as
begin
...
go
create proc USP_UpdateReceiveRoom
@id int,@idRoom int
as
begin
	update ReceiveRoom
...
END
GO
CREATE PROC USP_LoadFullAccessNow
@idStaffType INT
AS
BEGIN
...
END
GO
ALTER PROC USP_LoadFullAccessRest
@idStaffType INT
AS
BEGIN
...
END
GO
INSERT INTO Job(Name, NameForm) VALUES(N'Đặt Phòng', 'fBookRoom')
INSERT INTO Job(Name, NameForm) VALUES(N'Nhận Phòng', 'fReceiveRoom')
INSERT INTO Job(Name, NameForm) VALUES(N'Sử dụng dịch vụ và Thanh toán', 'fUseService')
INSERT INTO Job(Name, NameForm) VALUES(N'Thống kê và doanh thu', 'fReport')
INSERT INTO Job(Name, NameForm) VALUES(N'Quản lí phòng', 'fRoom')
INSERT INTO Job(Name, NameForm) VALUES(N'Quản lí nhân viên', 'fStaff')
INSERT INTO Job(Name, NameForm) VALUES(N'Quản lí khách hàng', 'fCustomer')
INSERT INTO Job(Name, NameForm) VALUES(N'Quản lí hoá đơn', 'fBill')
INSERT INTO Job(Name, NameForm) VALUES(N'Quản lí dịch vụ', 'fService')
INSERT INTO Job(Name, NameForm) VALUES(N'Quy định', 'fParameter')
GO
CREATE PROC USP_InsertAccess
